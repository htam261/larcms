...
@section('content')
    <div class="page-content">
        ...
        <h3 class="page-title"> Sửa tin tức
        </h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Sửa tin tức</div>
                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('backend.news.update',$services->id)}}" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <input type="radio" class="form-control"  name="type" value="1" {{ $services->type == '1' ?  'checked' : ''}}> Tin tức
                                        <input type="radio" class="form-control"  name="type" value="2" {{ $services->type == '2' ?  'checked' : ''}}> Tin khuyến mãi
                                        <input type="radio" class="form-control"  name="type" value="3" {{ $services->type == '3' ?  'checked' : ''}}> Sao trải nghiệm
                                    </div>
                                </div>
                                <div class="form-group">
