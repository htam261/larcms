...
@section('content')
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">Quản lý Khuyến mãi
        </h3>
        <div class="page-bar">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{route('backend.service.create')}}"><button id="sample_editable_1_new" class="btn sbold green"> Thêm Khuyến mãi
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{{route('backend.service.edit',$item->id)}}" class="btn grey-cascade"><i class="fa fa-edit"></i> Chỉnh sửa</a>
