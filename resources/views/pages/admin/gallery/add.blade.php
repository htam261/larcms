...
@section('content')
    <div class="page-content">
        ...
        <h3 class="page-title"> Thêm Thư viện
        </h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Thêm Thư viện</div>
                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('backend.gallery.store')}}" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post">
                            {!! csrf_field() !!}
                            <div class="form-body">
