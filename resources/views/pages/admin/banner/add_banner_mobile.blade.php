...
@section('content')
    <div class="page-content">
        ...
        <h3 class="page-title"> Thêm hình slider vào danh mục món ăn giao diện mobile
        </h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('backend.food.banner.storeimagemobile')}}" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">Chọn Danh mục</label>
                                    <div class="col-md-6 col-xs-12">
                                        <select class="bs-select form-control" name="category_id" required>
                                            <option>---Chọn vị trí xuất hiện banner---</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Số thứ tự <small>Ảnh sẽ hiển thị từ lớn tới nhỏ</small></label>
                                    <div class="col-md-6 col-xs-12">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function appendText() {
            ...
            var txt2 = '<div class="form-group"><label class="control-label col-md-3">Link '+x+'</label><div class="col-md-6 col-xs-12"><input type="text" class="form-control"  name="link[]" ></div></div>';
            $(".append").append(txt1, txt2);     // Append new elements
        }
    </script>
    @stop
