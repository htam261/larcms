...
@section('content')
    <div class="page-content">
        ...
        <h3 class="page-title"> Sửa Banner
        </h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Sửa Banner</div>
                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('backend.banner.update',$galleries->id)}}" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">Tiêu đề</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control"  name="title" value="{{old('title',$galleries->name)}}">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{ asset($galleries->images) }}" alt="" /> </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <input type="text" class="form-control"  name="link" value="{{ $galleries->link }}">
                                    </div>
                                </div>
