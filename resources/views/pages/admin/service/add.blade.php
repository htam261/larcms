            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Thêm mới</div>
                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{route('backend.news.store')}}" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post">
                            {!! csrf_field() !!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <input type="radio" class="form-control"  name="type" value="1" checked> Tin tức
                                        <input type="radio" class="form-control"  name="type" value="2" > Tin khuyến mãi
                                        <input type="radio" class="form-control"  name="type" value="3" > Sao trải nghiệm
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Ảnh banner hot (* Chỉ thêm khi hiển thị tin hot dành cho tin khuyến mãi)</label>
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" /> </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Hiển thị Tin tức hot</label>
                                    <div class="col-md-6 col-xs-12">
